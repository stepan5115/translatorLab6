# ============================================
# Makefile для проекта с ANTLR4 (лабораторная работа 6)
...
check_all: check_antlr check_antlr_runtime
...
info:
	@echo "$(BLUE)Информация о проекте (лабораторная работа 6):$(NC)"
	@echo "  Компилятор: $(CXX)"
	@echo "  Флаги: $(CXXFLAGS)"
...
help:
	...
	@echo "  make GRAMMAR_FILE=grammars/Lab6Grammar.g4"
	@echo "  make run GRAMMAR_FILE=grammars/Lab6Grammar.g4"
...
.PHONY: all clean clean_deps run debug valgrind help info \
        check_antlr check_jre download_jre generate_parser check_all